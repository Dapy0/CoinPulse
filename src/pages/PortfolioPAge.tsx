    ...
    <div className="dark:text-white mx-auto max-w-6xl flex flex-col justify-between ">
      <header className="flex justify-between items-start  mb-14 gap-4 flex-wrap">
        ...
        <div className="w-full sm:w-auto flex flex-col lg:flex-row h-full gap-4">
          <InputSearch />
          <Button><IconPlus />Add New Coin</Button>
        </div>
      </header>
          ...
          <div className="flex flex-col gap-2 rounded-lg p-6 border border-gray-300 dark:border-gray-600 bg-foreground ">
            ...
            <div className="relative flex items-center justify-center">
              <svg className="w-48 h-48 transform -rotate-90" viewBox="0 0 120 120">
                ...
                <circle className="transition-all duration-500" cx="60" cy="60" fill="none" r="54" stroke="#FBBF24" stroke-dasharray="291.56, 339.29" stroke-linecap="round" stroke-width="12" ></circle>
                <circle className="transition-all duration-500" cx="60" cy="60" fill="none" r="54" stroke="#60A5FA" stroke-dasharray="56.98, 339.29" stroke-linecap="round" stroke-width="12" ></circle>
                <circle className="transition-all duration-500" cx="60" cy="60" fill="none" r="54" stroke="#A78BFA" stroke-dasharray="4.14, 339.29" stroke-linecap="round" stroke-width="12"></circle>
              </svg>
